...
public class Z2HDispatcherServlet extends HttpServlet {
    ...
    private void reply(HttpServletResponse resp, Object resultToDisplay) {
        // serialize the output into JSON using ObjectMapper (Jackson)
    ...
    private Object dispatch(HttpServletRequest req, HttpMethod methodType) {
        ...
        // controllerInstance.invokeMethod(params))
        ...
        try {
            ...
            BeanDeserializator beanDes = new BeanDeserializator();
            Object[] params = beanDes.getMethodParams(methodAttributes.getMethod(), req).toArray();
            // methodAttributes.getMethod().getParameters()
